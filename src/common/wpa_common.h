...
/* TODO: Update the PQC AKM values once the ANA assignment is final */
#define RSN_AUTH_KEY_MGMT_802_1X_PQC RSN_SELECTOR(0x00, 0x0f, 0xac, 31)
#define RSN_AUTH_KEY_MGMT_FT_802_1X_PQC RSN_SELECTOR(0x00, 0x0f, 0xac, 32)
